  ...
  return (
    <ScrollView contentContainerStyle={{ paddingBottom: 80 }}>
      <ViewShot ref={viewRef}>
        <LinearGradient
          colors={['rgba(193,223,196,0)', 'rgba(238,248,238,0.9647)']}
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.company}>{companyDetails.name}</Text>
          </View>
          ...
          <View style={styles.infoRow}>
            <View style={styles.col}>
              ...
              <Row label="Employee ID" value={employeeDetails.employee_id} />
          ...
          <Text style={styles.note}>
            Note: This payslip is computer generated and does not require a
            signature.
          </Text>
        </LinearGradient>
      </ViewShot>
      ...
      <TouchableOpacity style={styles.downloadBtn} onPress={downloadPDF}>
        <Text style={{ color: '#f3f0f0' }}>Download PDF</Text>
      </TouchableOpacity>
    </ScrollView>
  );
};
